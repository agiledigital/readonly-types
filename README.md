...
| | `DeepImmutable` | | | [`DeepReadonly` from ts-essentials](https://github.com/ts-essentials/ts-essentials/tree/master/lib/deep-readonly), which when used will produce a mix of `Mutable` and `ReadonlyDeep` types |
* PRs welcome!
